...
class InformacionPersonal(models.Model):
    ...
    usuario = models.OneToOneField(Usuario, on_delete=models.CASCADE, unique=True, blank=True,
                                   null=True, verbose_name='Usuario')
    estado_civil = models.OneToOneField(EstadoCivil, on_delete=models.CASCADE, unique=True, blank=True, null=True,
                                        verbose_name='Estado Civil')
    tipo_documento = models.OneToOneField(TipoDeDocumento, on_delete=models.CASCADE, unique=True, blank=True, null=True,
                                          verbose_name='Tipo de documento')
    info_per_nro_doc = models.CharField(verbose_name='Nro. Documento', max_length=11, blank=True,
                                                     null=True)
