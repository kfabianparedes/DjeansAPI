...
class ProductoActualizarSerializer(Serializer):
    prod_id = serializers.IntegerField(required=True,
                                      error_messages={
                                          "required": "El ID del producto es requerido.",
                                          "blank": "El ID del producto no debe estar vacío.",
                                          "invalid": "El ID del producto debe ser válido.",
                                      })
    ...
    def update(self, instance, data):
        ...
        if data.get('prod_codigo') is not None:
            instance.prod_codigo = str(data.get('prod_codigo',instance.prod_codigo))
        else:
            instance.prod_codigo = ''
        instance.prod_descripcion = str(data.get('prod_descripcion',instance.prod_codigo))
        instance.prod_precio_compra_base = data.get('prod_precio_compra_base',instance.prod_precio_compra_base)
        ...
        instance.categoria = data.get('categoria', instance.categoria)
        instance.modelo = data.get('modelo', instance.modelo)
        instance.marca = data.get('marca', instance.marca)
        instance.prod_estado = data.get('prod_estado', instance.prod_estado)
